  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-slate-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
        ...
        caption_dropdowns: "flex gap-1 sm:py-2 sm:items-center w-50",
        ...classNames,
      }}
      components={{
