  ...
  return (
    <li className="relative">
      ...
      <div
        ...
        className={`absolute px-2 sm:right-0 sm:w-80 -right-30 mt-5 flex w-75 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-slate-700 ${
      ...
      >
        ...
        <ul className="flex h-auto flex-col overflow-y-auto">
          <li>
            <Link
              className="px-2 hover:bg-gray-2 flex flex-col gap-2.5 border-t border-stroke py-3 dark:border-strokedark dark:hover:bg-meta-4"
              href="#"
            >
              <p className="text-sm">
