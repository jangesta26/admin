...
import Error from '../../public/images/animations/404robot.png'
 
export default function NotFound() {
  return (
    <div className="rounded-sm px-5 py-10 dark:border-strokedark sm:py-20">
      <div className="mx-auto max-w-[410px]">
        ...
        <div className="mt-7 text-center">
          ...
          <p className="font-medium">
            The page you were looking for appears does not exist.
          </p>
          <Link
            href="/dashboard"
            className="mt-7 inline-flex items-center gap-2 rounded-md bg-primary px-6 py-3 font-medium text-white hover:bg-opacity-90"
          >
            <svg
